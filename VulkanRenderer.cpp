...
void VulkanRenderer::recordCommands()
{
	...
	bufferBeginInfo.flags = VK_COMMAND_BUFFER_USAGE_SIMULTANEOUS_USE_BIT;	// Buffer can be resubmited when it has already been submited and is awaiting execution
